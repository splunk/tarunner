module github.com/splunk/tarunner/pkg/splunkoutputsexporter
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/splunkhecexporter v0.157.0 // indirect
